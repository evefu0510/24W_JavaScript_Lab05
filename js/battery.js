...
// This is lab5 showing the image....
function displayImage(battery){
    const url = `https://robohash.org/set_set4/bgset_bg1/${battery.level * 100}?/size=500x500.png`;
    let img = document.createElement("img");
    img.src = url;
    img.alt = `Image ${battery.level}`;
    chargeLevel.appendChild(img);
}
